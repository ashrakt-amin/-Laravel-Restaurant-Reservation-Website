<x-guest-layout>
    ...
    <section class="mt-8 bg-white">
        ...
        <div class="container w-full px-5 py-6 mx-auto">
            ...
            <section class="mt-8 bg-white mb-5">
        <div class="mt-4 text-center">
        <p class="text-2xl font-bold " style="color:green;margin-bottom:50px">no special meal now</p>
            ...
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
                        src="{{asset('images/chef/ashrakt.jpeg')}}">
                </div>
                <div>
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Ashrakt</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
                    src="{{asset('images/chef/baba.jpeg')}}">
                </div>
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Food</h2>
                    <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Amin</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
                    src="{{asset('images/chef/hamada.jpeg')}}">
                </div>
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Food</h2>
                    <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Mohammed</a>
                </div>
            </div>
        </div>
    </section>
