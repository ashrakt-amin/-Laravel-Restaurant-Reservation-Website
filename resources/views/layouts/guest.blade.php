...
<body class="font-sans text-gray-900 antialiased ">
    <div class="bg-white shadow-md" x-data="{ isOpen: false }">
        <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
            ...
            <div :class="isOpen ? 'flex' : 'hidden'" class="flex-col mt-8 space-y-4 md:flex md:space-y-0 md:flex-row md:items-center md:space-x-10 md:mt-0">
                ...
                <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-green-400" href="{{route('ui.categories.index')}}">Categories</a>
                <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-green-400" href="{{route('ui.menus.index')}}">Our Menu</a>
                ...
                <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-green-400" href="{{route('admin.index')}}">Admin</a>
                @endif
    ...
    <div class="font-sans text-gray-500 antialiased min-h-screen " >
        <div class="" style="margin:100px 200px 100px 200px;">
        {{ $slot }}
        </div>
    </div>
